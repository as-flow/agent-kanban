  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50" onClick={onClose}>
      <div
        ...
        className="bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-700 rounded-xl p-6 w-full max-w-lg shadow-2xl max-h-[80vh] overflow-y-auto"
      >
            ...
            {groups.map((g) => (
              ...
              >
                <div className="min-w-0">
                  <div className="text-sm font-medium text-gray-800 dark:text-gray-200">{g.name}</div>
                ...
                <div className="flex gap-2 shrink-0 ml-3">
                  ...
                  <button
                    ...
                    className="text-xs text-red-500 hover:text-red-400 dark:text-red-400 dark:hover:text-red-300 cursor-pointer"
                  >
                    Delete
                  </button>
                </div>
        ...
        {!showForm && (
          <button
            onClick={startNew}
            className="w-full py-2 border border-dashed border-gray-300 rounded-lg text-sm text-gray-500 hover:text-gray-700 hover:border-gray-400 dark:border-gray-600 dark:text-gray-400 dark:hover:text-gray-200 dark:hover:border-gray-500 transition-colors cursor-pointer"
          >
            + New Group
          </button>
        )}
        ...
        {showForm && (
          <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 mt-2">
            <label className="block text-sm text-gray-500 dark:text-gray-400 mb-1">Group Name</label>
            <input
              autoFocus
              value={name}
              onChange={(e) => setName(e.target.value)}
              className="w-full px-3 py-2 bg-gray-50 border border-gray-200 dark:bg-gray-800 dark:border-gray-700 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 mb-3"
              placeholder="e.g. backend-services"
            />

            <label className="block text-sm text-gray-500 dark:text-gray-400 mb-2">Repositories</label>
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 rounded-lg text-sm font-medium text-white transition-colors cursor-pointer"
              >
